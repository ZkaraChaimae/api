...
public class getData_sncf_trips {
	...
	public void getStops() {
		...
		String csvFile = "src/main/resources/sncf/trips.txt";
		...
		try {
			...
			while ((line = reader.readNext()) != null) {
				...
				Resource route = model.createResource(Routes+line[0]);
	...
	public static void main(String[] args) {
		getData_sncf_trips GetIt = new getData_sncf_trips();
		GetIt.getStops();
	}
